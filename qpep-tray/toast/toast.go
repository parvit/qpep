...
var (
	...
	contentFilesTemplateHash = make(map[uint64]string)
)
...
func (n *Notification) buildXML() ([]byte, error) {
...
func (n *Notification) hash() uint64 {
	var h2 = fnv1a.Init64
	h2 = fnv1a.AddString64(h2, n.AppID)
	h2 = fnv1a.AddString64(h2, n.Title)
	h2 = fnv1a.AddString64(h2, n.Message)
	h2 = fnv1a.AddString64(h2, n.Icon)
	h2 = fnv1a.AddString64(h2, n.ActivationType)
	h2 = fnv1a.AddString64(h2, n.ActivationArguments)
	h2 = fnv1a.AddString64(h2, string(n.Audio))
	h2 = fnv1a.AddString64(h2, string(n.Duration))
	h2 = fnv1a.AddString64(h2, fmt.Sprintf("%v", n.Loop))
	for _, v := range n.Actions {
		h2 = fnv1a.AddString64(h2, v.Type)
		h2 = fnv1a.AddString64(h2, v.Label)
		h2 = fnv1a.AddString64(h2, v.Arguments)
	}
	return h2
}
...
func (n *Notification) getTemporaryScript() (string, error) {
	var h2 = n.hash()
	fCache, ok := contentFilesTemplateHash[h2]
	if ok {
		return fCache, nil
	}
	xml, err := n.buildXML()
	...
	out := append(bomUtf8, xml...)

	err = ioutil.WriteFile(file, out, 0600)
	if err != nil {
		return "", err
	}
	contentFilesTemplateHash[h2] = file
	return file, nil
}
